...
def generate_data():
    for n in graph_family_parameters:
        ...
        generate_train = """python data/generate_data.py --problem {} --dataset_size {} --dataset_folder {} \
            ...
            graph_family, weight_distribution, 
...
def train_model():
    for n in graph_family_parameters:
        ...
        train = """python run.py --problem {} --batch_size {} --embedding_dim {} --n_heads {} --u_size {}  --v_size {} --n_epochs {} \
            ...
            train_dir, val_dir, dataset_size, val_size, checkpoint_epochs, 
            baseline, lr_model, lr_decay, output_dir, log_dir, n_encode_layers, num_edges, n)
...
def evaluate_model():
    evaluate = """python eval.py --problem {} --load_path {} --eval_baselines {} --baseline {} --eval_models  {} --eval_dataset \
        ...
        problem, load_path, eval_baselines, baseline, eval_models, eval_dataset,
        u_size, v_size, eval_set, eval_size, eval_batch_size, n_encode_layers, n_heads, output_dir)

...
def evaluate_model():
        evaluate = """python eval.py --problem {} --load_path {} --eval_baselines {} --eval_models  {} --eval_dataset
            --u_size {} --v_size {} --eval_set {} --eval_size {} --eval_batch_size {} --n_encode_layers {} --n_heads {}""".format(
        problem, load_path, eval_baselines, eval_models, eval_dataset,
        u_size, v_size, eval_set, eval_size, eval_batch_size, n_encode_layers, n_heads)
